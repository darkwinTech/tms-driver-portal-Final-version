  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Requests awaiting review and processing.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="flex items-center justify-between px-5 py-4 border-b">
          ...
          <Link to="/queue" className="text-sm text-primary-600 hover:underline">View queue</Link>
        </div>
        {recent.length === 0 ? (
                ...
                {recent.map((r) => (
                  <tr key={r.id} className="border-t border-gray-100 hover:bg-gray-50">
                    <td className="px-5 py-2.5">
                      <Link to={`/queue/${r.id}`} className="text-primary-600 hover:underline font-medium">
                        {r.requestNumber}
                      </Link>
                    </td>
